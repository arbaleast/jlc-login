...
def main():
    try:
        ...
        #填写手机号
        browser.find_element(By.CSS_SELECTOR, 'div.txtwrap>input#p').send_keys('13135323109')
        #输入密码
        browser.find_element(By.CSS_SELECTOR, 'div.inputbox>input#pw').send_keys('cloudmusic.com,')
        #点击登录按钮
