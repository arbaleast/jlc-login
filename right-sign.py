...
def main():
	...
	print("输入账号密码中\n")
	browser.find_element(By.CSS_SELECTOR, 'td>input[name="username"]').send_keys(PHNU)
	browser.find_element(By.CSS_SELECTOR, 'td>input[name="password"]').send_keys(RIGHT_CODE)
